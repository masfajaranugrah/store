    ...
    $(document).ready(function () {
      var observer = new MutationObserver(function (mutations) {
          ...
          if (progressPath) {
              ...
              initializeProgress(progressPath);
          }
      });
  
      observer.observe(document.body, { childList: true, subtree: true });
  
      function initializeProgress(progressPath) {
          var pathLength = progressPath.getTotalLength();
  
          // Initialize the stroke style properties
          ...
          // Set up transition for progress path
          ...
          // Call updateProgress initially and on window scroll
          updateProgress();
          $(window).scroll(updateProgress);
  
          // Handle progress-wrap visibility on scroll
          var offset = 50;
          var duration = 550;
